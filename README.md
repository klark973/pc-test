...
опакечена для удобства, но по сути это набор скриптов, адаптированных под
различные дистрибутивы и бранчи, RPM-пакет практически не содержит жёстких
бинарных зависимостей, всё необходимое устанавливается по ходу. В случае
