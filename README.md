...
Для корректной работы автозапуска с графическим столом Gnome Shell, в домашнем
каталоге пользователя нужно предварительно создать каталог `.config/autostart`.
